...
class Indie3dModelController extends ChangeNotifier {
  ...
  Future<void> _loadMeshs(BuildContext context) async {
    _meshTorus = await loadVertexMeshFromOBJAsset(context, "images/objet", 'torus.obj');
    _meshStar = await loadVertexMeshFromOBJAsset(context, "images/objet", 'star.obj');
    _meshCube = await loadVertexMeshFromOBJAsset(context, "images/objet", 'cube.obj');
