...
class _Indie3dHomeState extends State<Indie3dHome> with TickerProviderStateMixin {
  ...
  Widget build(context) {
    if (!_controller.initialized) {
      precacheImage(AssetImage('images/pins-black.png', ), context);
      precacheImage(AssetImage('images/frank-black.png', ), context);
      precacheImage(AssetImage('images/noise.png',), context);
  ...
  Widget _buildPageForIndex(int index) {
    ...
    switch (index) {
      case 0:
        result = Indie3dPage(
          topTitle: 'PINS',
          bottomTitle: 'PRESTILIEN',
          contact: {'tel':"656176394",'github': 'https://github.com/pinsdev24/','email': "pinsdev24@gmail.com"},
          backgroundColor: Colors.teal,
          image: AssetImage('images/pins-black.png',),
          pageIndex: 0,
      ...
      case 1:
        result = Indie3dPage(
          topTitle: 'TCHATSEU',
          bottomTitle: 'FRANK',
          contact: {'tel':"696812610",'github': 'https://github.com/franktchatseu','email': "louenkamfrank@gmail.com"},
          backgroundColor: Colors.teal,
          image: AssetImage('images/frank-black.png', ),
          pageIndex: 1,
          controller: _controller,
      ...
      case 2:
        result = Indie3dPage(
          ...
          image: AssetImage('images/artist_3.png', ),
          pageIndex: 2,
          controller: _controller,
